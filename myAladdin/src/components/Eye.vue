...
<div class="box">
  ...
  <div class="content">
    ...
    <div class="one">
      ...
      <div class="one2">
        <img src="../../static/img/五角星.png" alt="">
      </div>
      <div class="one3 clearfix" >
        <div class="one3_1" v-for="i in 4" >
          <router-link to="/skin">
            <img src="../../static/img/eye1.png" alt="">
          </router-link>
          <p>蜗牛饰容BB霜50g</p>
          <p>￥12.90</p>
          <p>立即购买</p>
